...
Sync an Obsidian vault deployed via [vaults-template](https://github.com/wizzlethorpe/vaults-template) into Foundry VTT journals. Manifest-based incremental sync with role-based auth.
...
1. You deploy a vault using `vaults-template` (Cloudflare Pages).
